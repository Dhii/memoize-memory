...
class AbstractBaseContainerMemoryTest extends TestCase
{
    ...
    /**
     * Tests that `get()` works as expected when using a generator function.
     *
     * @since [*next-version*]
     */
    public function testGetGenerator()
    {
        ...
        for ($i = 0; $i < $attempts; ++$i) {
            $result = $subject->get($key, $generator, $ttl);
            $this->assertEquals($val, $result, sprintf('Wrong result on iteration #%1$d', [$i]));
        }
    }
}
