 ...
 * @since [*next-version*]
 */
class MemoryMemoizerTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Cache\MemoryMemoizer';
    ...
    {
        $subject = $this->createInstance(['_construct']);
    ...
    {
        $subject = $this->createInstance(['clear']);
        $_subject = $this->reflect($subject);
